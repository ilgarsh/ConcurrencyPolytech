...
import practice1.concurrency.CircularParallelHandler;
import practice1.concurrency.ParallelHandler;
import practice1.concurrency.Vector;
...
@State(Scope.Thread)
public class BenchmarksPractice1 {
    ...
    public static void main(String[] args) throws RunnerException {
        Options options = new OptionsBuilder()
                .include(BenchmarksPractice1.class.getSimpleName())
                .warmupIterations(5)
